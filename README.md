...
### 🚀 **独立翻译面板 + 翻译历史 + 生词本（全新！）**
- **快捷面板** - 按 `Ctrl+Shift+T` 呼出独立浮动面板，可在任何页面快速翻译
...
### 快捷面板（Ctrl+Shift+T）
1. **呼出面板** - 按 `Ctrl+Shift+T` 在页面任意位置弹出浮动面板
...
<details>
<summary>📋 <strong>界面布局详解 (v2.5.0)</strong></summary>
...
```
┌─────────────────────────────────┐
│   QuickTranslate 快译 v2.5.0    │  ← 🎨 紫色渐变标题
│  [简体中文 ▼]              v2.5.0 │  ← 🌍 语言选择器
├─────────────────────────────────┤
│      📷 开始翻译                 │  ← 🎯 主操作按钮
...
> 🆕 **v2.5.0 新增**：标题栏右侧新增语言选择器和历史/生词本按钮
