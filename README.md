# 📷 4utrans - 智能网页翻译助手 (v1.5.0)

> 🚀 **全新升级** - 基于先进DOM技术的智能翻译扩展，支持大模型翻译，为您提供无与伦比的网页翻译体验

一个功能强大且经过全面优化的 Chrome 浏览器扩展，采用创新的DOM文字提取技术和模块化架构，实现精确的网页文字识别和即时翻译。支持 **Google、Microsoft 免费翻译** 以及 **GLM、OpenAI 兼容格式大模型翻译**，为您提供快速、准确、稳定的翻译服务。
...
[![Version](https://img.shields.io/badge/version-1.5.0-green)](https://github.com/kany2000/4utrans)
