# 4utrans Release Builder - Simplified Version
param(
...
Write-Host "Building 4utrans v$Version release packages..." -ForegroundColor Green
...
# Create user version
$userDir = "4utrans-v$Version-user"
...
Write-Host "  1. Go to https://github.com/kany2000/4utrans/releases" -ForegroundColor White
