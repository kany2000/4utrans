...
# QuickTranslate Release Builder - Unix/Linux/macOS Version

if [ -z "$1" ]; then
    echo "用法: ./build-release.sh <版本号>"
    echo "例如: ./build-release.sh 2.0.0"
    exit 1
fi
...
echo "Building QuickTranslate v$VERSION release packages..."
...
echo ""
echo "Next steps:"
echo "  1. Go to https://github.com/kany2000/QuickTranslate/releases"
